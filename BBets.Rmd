...
The probability that two students would have the same birthday is 0.816. 
...
In a class of 26 students, Professor J's expected profit is 21.15. 
...
The confidence interval would be 0.811 to 0.816. 
...
In order for the bet to be fair, Professor J would need to wager $4.40. 
...
```
The number of students needed for a fair game 1:1 is 23
